    ...
    <footer className="border-t border-black/5 dark:border-white/5 px-4 sm:px-6 py-10">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.instagram.com/where.app.hq/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#888888] hover:text-[#0c0c0c] dark:hover:text-white transition-colors">
          ...
          <a href="https://www.tiktok.com/@where.app.hq" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#888888] hover:text-[#0c0c0c] dark:hover:text-white transition-colors">
          ...
          <a href="https://x.com/where_app_hq" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-[#888888] hover:text-[#0c0c0c] dark:hover:text-white transition-colors">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
