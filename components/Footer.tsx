    ...
    <footer className="border-t border-white/5 px-4 sm:px-6 py-10">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <a href="#" aria-label="TikTok" className="text-[#888888] hover:text-white transition-colors">
          ...
          <a href="#" aria-label="Instagram" className="text-[#888888] hover:text-white transition-colors">
